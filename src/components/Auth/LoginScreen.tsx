...
const LoginScreen: React.FC<LoginScreenProps> = ({ onLogin }) => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-3 sm:p-4 lg:p-6 relative overflow-hidden bg-gradient-to-br from-[#e6fcf5] via-[#f0fdf4] to-[#ecfdf5]">
            ...
            <div className="w-full max-w-5xl bg-white/85 backdrop-blur-xl rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row relative z-10 border border-white/50">
                ...
                <div className="md:w-1/2 p-6 sm:p-8 lg:p-10 flex flex-col justify-center items-center text-center bg-gradient-to-br from-emerald-600 to-green-700 text-white flex flex-col justify-between relative overflow-hidden min-h-[280px] md:min-h-[620px]">
                    ...
                    <div className="z-10 w-full flex flex-col items-center">
                        ...
                        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold mb-2 leading-tight tracking-tight">
                            {t('brand.name')}
                        </h1>
                        <h2 className="text-base sm:text-lg font-medium text-emerald-100 mb-3 sm:mb-4 font-sans">
                            {t('brand.tagline')}
                        </h2>
                        <p className="text-xs sm:text-sm text-emerald-50/90 leading-relaxed font-light max-w-md">
                            {language === 'th'
                    ...
                    <div className="z-10 mt-8 sm:mt-12">
                        <div className="flex items-center justify-center gap-2 text-[10px] sm:text-xs font-bold text-emerald-200 uppercase tracking-widest mb-2">
                            System
                        </div>
                        <div className="text-2xl sm:text-3xl lg:text-4xl font-black text-white tracking-tighter shadow-sm">
                            Classroom Companion
                        </div>
                    </div>
                </div>
                ...
                <div className="md:w-1/2 p-5 sm:p-7 md:p-9 lg:p-10 flex flex-col justify-center">
                    ...
                    <div className="space-y-4 sm:space-y-5">
                        ...
                        <section className="rounded-2xl border border-emerald-100 bg-emerald-50/50 p-4 sm:p-5">
                            <div className="flex items-start justify-between gap-3">
                                ...
                                <span className="text-[10px] sm:text-xs font-semibold px-2 py-1 rounded-full bg-white text-emerald-700 border border-emerald-200">
                        ...
                        <section className="rounded-2xl border border-slate-200 bg-white p-4 sm:p-5">
                            ...
                            <button
                                ...
                                className="w-full min-h-11 flex items-center justify-center gap-2 bg-gradient-to-r from-emerald-800 to-green-900 text-white hover:from-emerald-700 hover:to-green-800 shadow-lg hover:shadow-xl transition-all px-4 sm:px-6 py-3 rounded-xl font-medium text-sm"
                            >
